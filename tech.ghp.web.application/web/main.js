...
(function() {
	...
	var MODULE = angular.module('tech.ghp.web',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/tech.ghp.web/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/tech.ghp.web/main/htm/about.htm'});
